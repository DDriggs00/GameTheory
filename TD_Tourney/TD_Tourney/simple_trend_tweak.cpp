...
simple_trend_tweak::simple_trend_tweak(int k_in, double eps_in)
{
	k = k_in;
	eps = eps_in;
	logging = false;
	...
	name = "Simple Trend Tweak - K = ";
	short_name = "STrend Tweak K=";
...
simple_trend_tweak::simple_trend_tweak(void)
{
	name = "Simple Trend Tweak Unitialized";
	short_name = "STrend Tweak Unitialized";
}
